...
public class CreateInteresrAsynTask extends AsyncTask<String, Object, Object>
{
	...
	public CreateInteresrAsynTask(RequestBean requestBean)
	{
	...
	protected Object doInBackground(String... params)
	{
		...
		CreateInterestBean createInterestBean =  mAppParser.parseCreateInterest(response);
	...
	protected void onPostExecute(Object result)
	{
		...
		if(mRequestBean.getActivity() instanceof CreateInterestActivity)
		{
			((CreateInterestActivity)mRequestBean.getActivity()).setCreateInterestResponse((CreateInterestBean)result);
		}
