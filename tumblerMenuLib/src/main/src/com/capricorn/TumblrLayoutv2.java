...
public class TumblrLayoutv2 extends ViewGroup {
    ...
    public TumblrLayoutv2(Context context) {
        super(context);
    }

    public TumblrLayoutv2(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//                 right  = (measuredWidth - (childIndex+1) * (gap + size) + gap);
            right  = (measuredWidth - (childIndex) * (gap+size/rightTranslate)+gap);
        }
